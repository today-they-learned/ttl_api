...
class LoginView(BaseView, GenericAPIView):
    """
...
class UserDetailsView(BaseView, RetrieveUpdateAPIView):
    """
...
class PasswordResetConfirmView(BaseView, GenericAPIView):
    """
...
class PasswordChangeView(BaseView, GenericAPIView):
    """
